...
const PaymentReceiptSelector = ({ formData, setFormData }) => {
  const selectedMethod = formData.receivingMethod;
      ...
      <div className="border rounded-lg overflow-hidden border-gray-200">
        {paymentMethods.map((method, index) => (
          <div
            ...
            onClick={() =>
              setFormData({ ...formData, receivingMethod: method.id })
            }
          >
...
export default PaymentReceiptSelector;
